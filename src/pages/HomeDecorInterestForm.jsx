        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center mb-4">
              <img
                src="/images/pillow_one.jpg"
                alt="Custom pillow sample"
                className="mx-auto rounded shadow-md w-full max-w-xs"
              />
            </div>
            ...
            {/* Image between description and form */}
            <div className="flex justify-center mt-4">
              <img
                src="/images/pillow_two.jpg"
                alt="Stack of decorative pillows"
            ...
            <label htmlFor="message" className="block text-black bg-[#A33A6A] font-medium mb-1"></label>
            <textarea
              id="message"
              name="message"
              rows="4"
          ...
          <div className="text-center font-kaisei space-y-4">
            ...
            {/* Image after submission */}
            <img
              src="/images/pillow_two.jpg"
              alt="Thank you pillow"
              className="mx-auto rounded w-full max-w-xs"
            />
          </div>
        )}
      </div>
